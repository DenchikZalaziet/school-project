...
DEFAULT_ACCESS_TOKEN_EXPIRE_MINUTES = float(
    os.getenv("DEFAULT_ACCESS_TOKEN_EXPIRE_MINUTES", "20")
)

DEFAULT_SCALE_NAME_CHANGE_PREVENT = os.getenv(
    "DEFAULT_SCALE_NAME_CHANGE_PREVENT", "По умолчанию"
)

USER_NAME_MAX_LENGTH = int(os.getenv("USER_NAME_MAX_LENGTH", 30))

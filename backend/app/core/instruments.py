...
def get_all_instruments(
    collection=Depends(get_instruments_collection),
) -> list[Instrument]:
...
def get_instrument_by_id(
    instrument_id: str, collection: Collection = Depends(get_instruments_collection)
) -> Instrument:
    try:
...
def get_all_instrument_tunings(
    instrument_id: str,
    collection: Collection = Depends(get_instrument_tunings_collection),
) -> list[Tuning]:
    try:
